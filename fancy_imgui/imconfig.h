...
// using soon-to-be obsolete function/names. #define IMGUI_DISABLE_OBSOLETE_FUNCTIONS #define
...
// Disable metrics/debugger and other debug tools: ShowMetricsWindow(), ShowDebugLogWindow() and ShowStackToolWindow()
// will be empty (this was called IMGUI_DISABLE_METRICS_WINDOW before 1.88).
