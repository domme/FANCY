...
**
** Created: Wed 28. Nov 19:18:55 2012
...
static const char qt_meta_stringdata_DeferredRendererQApp[] = {
    "DeferredRendererQApp\0\0onGLinit()\0x,y\0"
    "onGLresize(int,int)\0onGLpaint()\0"
};
...
const QMetaObjectExtraData DeferredRendererQApp::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DeferredRendererQApp::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_DeferredRendererQApp,
      qt_meta_data_DeferredRendererQApp, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeferredRendererQApp::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeferredRendererQApp))
