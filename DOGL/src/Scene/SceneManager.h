...
class DLLEXPORT SceneManager
{
	...
	public:		
		...
		VolumeEntity*					CreateVolumeEntity( const String& szBaseTexPath, uint uStartIndex, uint uEndIndex, const String& szExtension, const String& szTransferFuktionPath );
