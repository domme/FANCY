...
#define ANNOTATION_CREATE_TAG( anId, aName, aColor ) const uint16 anId = Fancy::Annotations::CreateTag( aName, aColor );

#define ANNOTATION_USE_TAG( anId ) extern const uint16 anId;