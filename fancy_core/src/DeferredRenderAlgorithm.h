...
class DeferredRenderAlgorithm
{
	public: 
		static DeferredRenderAlgorithm& GetInstance();
		
		GLuint GetOutputTexture() const { return m_uFinalCompositeTex_07; }
		GLuint GetOutputFBO() const { return m_uFinalCompositeFBO_07; }
		void Init( uint uWidth, uint uHeight, Renderer* glRenderer );
