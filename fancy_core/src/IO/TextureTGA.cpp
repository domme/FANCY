...
bool TextureTGA::isImageTypeSupported(const TargaHeader& header)
{
...
bool TextureTGA::isCompressedTarga(const TargaHeader& header)
{
    return (header.imageTypeCode == TFT_RLE_RGB || 
            header.imageTypeCode == TFT_RLE_GRAYSCALE);
}

bool TextureTGA::isUncompressedTarga(const TargaHeader& header)
{
    return (header.imageTypeCode == TFT_RGB || 
            header.imageTypeCode == TFT_GRAYSCALE);
}

bool TextureTGA::load(const string& filename)
{
...
void TextureTGA::unload()
{
    m_imageData.clear();
}

bool TextureTGA::loadCompressedTarga(istream& fileIn)
{
...
bool TextureTGA::loadUncompressedTarga(istream& fileIn)
{
...
unsigned int TextureTGA::getWidth() const
{
    return m_width;
}

unsigned int TextureTGA::getHeight() const
{
    return m_height;
}

unsigned int TextureTGA::getBitsPerPixel() const
{
...
const unsigned char* TextureTGA::getImageData() const
{
...
/**
 ...
 wrong way
 */
void TextureTGA::flipImageVertically()
{
