...
class  DLLEXPORT MAT_TexturedNormalSpecular : public Material
{
public:
	...
	Texture&	GetSpecularTexture() { return m_clSpecTexture; }
	Texture&	GetGlossTexture() { return m_clGlossTexture; }
...
protected:
	...
	Texture	m_clSpecTexture;
	Texture	m_clGlossTexture;
