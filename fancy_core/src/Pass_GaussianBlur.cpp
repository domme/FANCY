...
void Pass_GaussianBlur::BlurTextureIntoFBO( GLuint uSrcTexture, GLuint uDestFBO, uint uDestWidth, uint uDestHeight, GLenum eInternalFormat, GLenum eFormat, GLenum eDatatype, Renderer* pRenderer, Camera* pCamera, uint uBlurStrength /* = 3 */ )
{
