...
DeferredRenderAlgorithm::DeferredRenderAlgorithm() :
...
void DeferredRenderAlgorithm::deleteResoultionDependentResources()
{
...
void DeferredRenderAlgorithm::Init( uint uWidth, uint uHeight, Renderer* glRenderer )
{
...
void DeferredRenderAlgorithm::OnResolutionChanged( glm::ivec2 vRes )
{
...
void DeferredRenderAlgorithm::updatePostproMaterials()
{
...
void DeferredRenderAlgorithm::updateTextures()
{
...
DeferredRenderAlgorithm& DeferredRenderAlgorithm::GetInstance()
{
  static DeferredRenderAlgorithm instance;
  return instance;
}
...
void DeferredRenderAlgorithm::renderEntity( Entity* pEntity, const SceneManager* pScene, const Camera *pCamera )
{
  ...
  GPUProgram* pShader =  pMesh->GetMaterial()->GetShader();
...
void DeferredRenderAlgorithm::renderEntities( SceneManager* pScene, Camera* pCamera )
{
...
void DeferredRenderAlgorithm::renderShadowMap( PointLight* pLight, SceneManager* pScene, Camera* pCamera )
{
...
void DeferredRenderAlgorithm::renderShadowMap( DirectionalLight* pLight, SceneManager* pScene, Camera* pCamera )
{

}


void DeferredRenderAlgorithm::renderDirLight( DirectionalLight* pLight, SceneManager* pScene, Camera* pCamera )
{
  m_pFSquad->RenderWithMaterial( m_pMAT_Dirlight, pCamera );
}

void DeferredRenderAlgorithm::renderPointLight( PointLight* pLight, SceneManager* pScene, Camera* pCamera )
{
...
void DeferredRenderAlgorithm::RenderScene( SceneManager* pSceneManager )
{
