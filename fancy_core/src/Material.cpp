...
{
	if( other.m_pShader )
		m_pShader = new GPUProgram( *other.m_pShader );
...
void Material::assignAttributeSemantic( GPUProgram* pShader, const String& szName, ShaderSemantics::Semantic eSemantic )
{
...
void Material::assignUniformSemantic( GPUProgram* pShader, const String& szName, ShaderSemantics::Semantic eSemantic )
{
...
void Material::assignUniformSemantic( GPUProgram* pShader, const String& szName, ShaderSemantics::Semantic eSemantic, int index )
{
	IUniform* pUniform = pShader->GetUniformByName( szName );
