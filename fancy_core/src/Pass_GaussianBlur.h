...
class Pass_GaussianBlur
{
	public: 
		...
		void BlurTextureIntoFBO( GLuint uSrcTexture, GLuint uDestFBO, uint uDestWidth, uint uDestHeight, GLenum eInternalFormat, GLenum eFormat, GLenum eDatatype, Renderer* pRenderer, Camera* pCamera, uint uBlurStrength = 3 );
