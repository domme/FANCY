...
namespace Fancy {
  ...
  template < class T > struct GetSerializeFunc {
  ...
  //---------------------------------------------------------------------------//
  template < class T > void BinarySerializer::Serialize( eastl::vector< T > & aVal ) {
    if ( IsReading() ) {
      uint size = 0u;
      Serialize( size );
      aVal.resize( size );
  ...
  //---------------------------------------------------------------------------//
  template < class T, uint N > void BinarySerializer::Serialize( eastl::fixed_vector< T, N > & aVal ) {
    if ( IsReading() ) {
      uint size = 0u;
      Serialize( size );
      aVal.resize( size );
  ...
  //---------------------------------------------------------------------------//
  template < class T, uint N > void BinarySerializer::Serialize( eastl::fixed_string< T, N > & aString ) {
    if ( IsReading() ) {
      uint name_size;
      Serialize( name_size );
