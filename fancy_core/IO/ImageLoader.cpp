...
static bool LoadImage_STB( FILE * file, const char * aPathAbs, uint someLoadFlags, ImageData & anImageOut ) {
  ...
  switch ( desiredNumChannels ) {
    case 1:
      props.myFormat = is16Bit ? DataFormat::R_16 : DataFormat::R_8;
      break;
    case 2:
      props.myFormat = is16Bit ? DataFormat::RG_16 : DataFormat::RG_8;
      break;
      // 3-channels unsupported in all modern rendering-APIs. Image-importer lib should deal with it to convert it to 4
      // channels
    case 4:
      props.myFormat = is16Bit ? DataFormat::RGBA_16 : DataFormat::SRGB_8_A_8;
      break;
    default:
      ASSERT( false, "Unsupported channels" );
      return nullptr;
  }
