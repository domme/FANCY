...
namespace Fancy {
  ...
  namespace Path {
    ...
    //---------------------------------------------------------------------------//
    /// The root folder is the folder the FANCY-folder is residing in, so that e.g. resources can be adressed with
    /// "Fancy/resources/..." for engine-resources or "resources/" for project-resources The relativeRootFolder should
    /// identify this folder relative to the .exe
