...
namespace Fancy {
  ...
  struct DepthStencilStateProperties {
    ...
    static uint64 Hash( const DepthStencilStateProperties & aDesc ) {
  ...
  public:
    DepthStencilState( DepthStencilStateProperties aProperties ) : myProperties( aProperties ) {}

    const DepthStencilStateProperties & GetProperties() const {
      return myProperties;
    }
