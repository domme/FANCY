...
//---------------------------------------------------------------------------//
  ...
  {
    const GpuResourceViewDataVk & viewDataVk = aView->myVkData;
...
//---------------------------------------------------------------------------//
  TextureView * RenderCore_PlatformVk::CreateTextureView( Texture * aTexture, const TextureViewProperties & someProperties,
                                                           const char * aDebugName )
  {
    return new TextureViewVk(aTexture, someProperties, aDebugName);
  }
//---------------------------------------------------------------------------//
  GpuBufferView * RenderCore_PlatformVk::CreateBufferView( GpuBuffer * aBuffer,
