...
//---------------------------------------------------------------------------//
  ...
  {
    return myVkData.myImage != nullptr ? &myVkData : nullptr;
  }
//---------------------------------------------------------------------------//
...
//---------------------------------------------------------------------------//
  TextureViewVk::TextureViewVk( Texture * aTexture, const TextureViewProperties & someProperties, const char * aName )
    : TextureView(aTexture, someProperties, aName)
  {
    ...
    nativeData.myView.myImage = Priv_TextureViewVk::locCreateImageView(aTexture, someProperties);
...
//---------------------------------------------------------------------------//
  ...
  {
    const GpuResourceViewDataVk & viewDataVk = myVkData;
