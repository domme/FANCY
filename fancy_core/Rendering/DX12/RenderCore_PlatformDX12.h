...
#include "Rendering/RenderCore_Platform.h"
...
namespace Fancy {
  ...
  public:
    ...
    ShaderVisibleDescriptorHeapDX12 * GetShaderVisibleDescriptorHeap() {
      return myShaderVisibleDescriptorHeap.get();
    }
