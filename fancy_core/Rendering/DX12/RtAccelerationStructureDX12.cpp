...
namespace Fancy {
  ...
  namespace Private {
    ...
    static void GetTLASInstanceDescs( const RtAccelerationStructureInstanceData * someInstanceDatas, uint aNumInstances,
                                      eastl::vector< D3D12_RAYTRACING_INSTANCE_DESC > & someInstanceDescsOut ) {
