...
namespace Fancy {
  ...
  struct VertexInputAttributeDesc {
    VertexInputAttributeDesc( DataFormat              aFormat = DataFormat::NONE,
                              VertexAttributeSemantic aSemantic = VertexAttributeSemantic::NONE,
                              uint aSemanticIndex = 0u, uint aBufferIndex = 0u )
        : myFormat( aFormat ), mySemantic( aSemantic ), mySemanticIndex( aSemanticIndex ),
  ...
  struct VertexInputLayoutProperties {
    ...
    static uint64 Hash( const VertexInputLayoutProperties & aDesc ) {
