...
#define DECLARE_DATA_FORMAT( name, byteSize, byteSizePlane0, byteSizePlane1, numComponents, numPlanes, depthStencil, srgb, compressed, isUintInt, blockSize )  \
  { DataFormat::name, byteSize, byteSizePlane0, byteSizePlane1, numComponents, numPlanes, depthStencil, srgb, compressed, isUintInt, blockSize },
