...
namespace Fancy {
  ...
  public:
    ...
    void SetMaxAttributeSize( uint aSizeBytes ) {
      myMaxAttributeSizeBytes = aSizeBytes;
    }
    void SetMaxRecursionDepth( uint aMaxDepth ) {
      myMaxRecursionDepth = aMaxDepth;
    }
  ...
  public:
    RtPipelineState( const RtPipelineStateProperties & someProps ) : myProperties( someProps ) {}
