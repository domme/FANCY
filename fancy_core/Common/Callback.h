...
namespace Fancy {
  ...
  Callback< ReturnT( void ) > Bind( ClassT * anInstance, ReturnT ( ClassT::*aMemFnPtr )( void ) ) {
  ...
  Callback< ReturnT( Arg1T ) > Bind( ReturnT ( *aFnPtr )( Arg1T ), const Arg1T & anArg ) {
  ...
  Callback< ReturnT( Arg1T, Arg2T ) > Bind( ClassT * anInstance, ReturnT ( ClassT::*aMemFnPtr )( Arg1T, Arg2T ) ) {
    std::function< ReturnT( Arg1T, Arg2T ) > func =
        std::bind( aMemFnPtr, anInstance, std::placeholders::_1, std::placeholders::_2 );
  ...
  Callback< ReturnT( Arg1T, Arg2T ) > Bind( ReturnT ( *aFnPtr )( Arg1T, Arg2T ) ) {
  ...
  //---------------------------------------------------------------------------//
  template < class ReturnT, class Arg1T, class Arg2T >
  Callback< ReturnT( Arg1T, Arg2T ) > Bind( ReturnT ( *aFnPtr )( Arg1T, Arg2T ), const Arg1T & anArg1,
                                            const Arg2T & anArg2 ) {
  ...
  Callback< ReturnT( Arg1T, Arg2T, Arg3T ) > Bind( ClassT * anInstance,
  ...
  Callback< ReturnT( Arg1T, Arg2T, Arg3T ) > Bind( ClassT * anInstance,
                                                   ReturnT ( ClassT::*aMemFnPtr )( Arg1T, Arg2T, Arg3T ),
                                                   const Arg1T & anArg1, const Arg2T & anArg2, const Arg3T & anArg3 ) {
  ...
  //---------------------------------------------------------------------------//
  template < class ReturnT, class Arg1T, class Arg2T, class Arg3T >
  Callback< ReturnT( Arg1T, Arg2T, Arg3T ) > Bind( ReturnT ( *aFnPtr )( Arg1T, Arg2T, Arg3T ), const Arg1T & anArg1,
  ...
  template < class ClassT, class ReturnT, class Arg1T, class Arg2T, class Arg3T, class Arg4T >
  Callback< ReturnT( Arg1T, Arg2T, Arg3T, Arg4T ) >
  Bind( ClassT * anInstance, ReturnT ( ClassT::*aMemFnPtr )( Arg1T, Arg2T, Arg3T, Arg4T ), const Arg1T & anArg1,
        const Arg2T & anArg2, const Arg3T & anArg3, const Arg4T & anArg4 ) {
    std::function< ReturnT( Arg1T, Arg2T, Arg3T, Arg4T ) > func =
