...
namespace Fancy {
  /*
   * A freelist-based linear allocator with custom page-data and callback-functions for reacting on creation/destruction
   * of pages. Useful for situations where custom data needs to be associated with each page (e.g. resource-heaps in
   * DX12)
   */
  ...
  public:
    ...
    virtual bool CreatePageData( uint64 /*aSize*/, eastl::any & /*aPageData*/ ) {
      return true;
    }
